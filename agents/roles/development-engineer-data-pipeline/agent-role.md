...
mission: Deliver production grade data pipeline implementations from approved specs with strong tests maintainable design and operational reliability.
...
Development Engineer Data Pipeline is accountable for implementation quality in the data pipeline stack or language area. The role turns approved specs into maintainable code with test coverage observability and safe rollout behavior under real operating conditions.
