...
mission: Produce unambiguous and testable liveops specifications that align product intent design constraints and implementation scope.
...
LiveOps Spec Writer converts ambiguous intent into complete and testable specifications. The role ensures requirements are scoped sequenced and measurable so implementation and validation roles can execute with minimal rework and low interpretation risk.
