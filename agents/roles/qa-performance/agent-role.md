...
mission: Own performance validation strategy and execution so releases meet functional reliability and readiness requirements.
...
QA Performance owns validation rigor for the performance domain and determines whether work is ready to advance. The role ensures evidence based quality decisions through risk informed test design coverage analysis and explicit release gates.
