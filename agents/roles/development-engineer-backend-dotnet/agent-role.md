...
mission: Deliver production grade backend .net implementations from approved specs with strong tests maintainable design and operational reliability.
...
Development Engineer Backend .NET is accountable for implementation quality in the backend .net stack or language area. The role turns approved specs into maintainable code with test coverage observability and safe rollout behavior under real operating conditions.
