...
mission: Deliver production grade frontend react implementations from approved specs with strong tests maintainable design and operational reliability.
...
Development Engineer Frontend React is accountable for implementation quality in the frontend react stack or language area. The role turns approved specs into maintainable code with test coverage observability and safe rollout behavior under real operating conditions.
