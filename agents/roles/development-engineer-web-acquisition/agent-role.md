...
mission: Deliver production grade web acquisition implementations from approved specs with strong tests maintainable design and operational reliability.
...
Development Engineer Web Acquisition is accountable for implementation quality in the web acquisition stack or language area. The role turns approved specs into maintainable code with test coverage observability and safe rollout behavior under real operating conditions.
