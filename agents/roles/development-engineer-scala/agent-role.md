...
mission: Deliver production grade scala implementations from approved specs with strong tests maintainable design and operational reliability.
...
Development Engineer Scala is accountable for implementation quality in the scala stack or language area. The role turns approved specs into maintainable code with test coverage observability and safe rollout behavior under real operating conditions.
