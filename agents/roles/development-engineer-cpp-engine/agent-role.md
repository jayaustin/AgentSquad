...
mission: Deliver production grade c++ engine implementations from approved specs with strong tests maintainable design and operational reliability.
...
Development Engineer C++ Engine is accountable for implementation quality in the c++ engine stack or language area. The role turns approved specs into maintainable code with test coverage observability and safe rollout behavior under real operating conditions.
