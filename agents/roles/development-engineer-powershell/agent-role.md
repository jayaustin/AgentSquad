...
mission: Deliver production grade powershell implementations from approved specs with strong tests maintainable design and operational reliability.
...
Development Engineer Powershell is accountable for implementation quality in the powershell stack or language area. The role turns approved specs into maintainable code with test coverage observability and safe rollout behavior under real operating conditions.
